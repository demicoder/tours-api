...
var PORT = 3000;
var BASE_URL = "http://localhost:".concat(PORT, "/api/v1/users");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Successfully logged in');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'An error occured while logging out.');
